...
//     <>
//       <header
//         className={`w-full h-[100px] md:pe-0 ${isCollapsed ? 'sticky top-0 p-0 flex' : 'hidden -translate-y-5'} transition-all justify-between items-center bg-cover bg-center border-b-gray-200 border-b-2`}
//       >
...
//       </header>
//       <header
//         className={`w-full h-[100px] md:pe-0 ${isCollapsed ? '' : 'fixed top-0'} bg-cover bg-center border-b-gray-200 border-b-2`}
//       >
